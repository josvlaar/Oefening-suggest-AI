...
-- Dumping data for table sample1.answers: ~0 rows (approximately)
...
REPLACE INTO `questions` (`id`, `question`, `answerA`, `answerB`, `answerC`, `answerD`, `correctanswer`, `avgtime`, `numofanswers`) VALUES
	(1, 'A', 'A', 'B', 'C', 'D', 'A', NULL, NULL),
	(2, 'B', 'A', 'B', 'C', 'D', 'B', NULL, NULL),
	(3, 'C', 'A', 'B', 'C', 'D', 'C', NULL, NULL),
	(4, 'D', 'A', 'B', 'C', 'D', 'D', NULL, NULL);
...
-- Dumping data for table sample1.users: ~0 rows (approximately)
